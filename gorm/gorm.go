...
import (
	...
	"github.com/fangxing98/jx-gorm/gorm/logger"
...
type DB struct {
	*Config
	...
	DBType DBType // 数据库类型 mysql kingbase
}
...
func Open(dialector Dialector, dbType DBType, opts ...Option) (db *DB, err error) {
	config := &Config{}
	...
	db = &DB{Config: config, clone: 1, DBType: dbType}
